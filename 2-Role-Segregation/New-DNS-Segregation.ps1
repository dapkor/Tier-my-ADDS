...
.EXAMPLE
    .\DNS_separate.ps1 -ConfigPath .\dns-separation.config.json

.EXAMPLE
    .\DNS_separate.ps1 -ConfigPath .\dns-separation.config.json -LintConfigOnly

.EXAMPLE
    .\DNS_separate.ps1 -ConfigPath .\dns-separation.config.json -Force
#>
